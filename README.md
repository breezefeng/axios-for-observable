...
// or const Axios = require('axios-for-observable').Axios;
...
## axios-for-observable API

### Yeah! We use the exact same config object as axios.

##### Axios.request(config) (We support using Axios as a function as opposed to axios library)
...
## Cancellation (Big win for axios-for-observable)
...
## TypeScript
axios-for-observable includes [TypeScript](http://typescriptlang.org) definitions.
```typescript
import Axios from 'axios-for-observable';
// or import {Axios} from 'axios-for-observable';
Axios.get('/user?ID=12345');
```
